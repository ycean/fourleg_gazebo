...
def FS_define0(Pcomx,Pcomy,Pcomz,Orient,fs,loop = None):

    roll,pitch,yaw = Orient


    f_sq = fs % 4
    #Walking Sequence : 1 - 3 - 2 - 4
    if (f_sq == 0): #Lift leg 1 turn leg 4
        if (loop == 0): #Initial step
            ...
            Q4_2 = -pi/8
            Q4_3 = 5*pi/8
    elif(f_sq == 1): #Lift leg 3 turn leg 1
        Q1_1 = -pi/8  #SMALL ANGLE FOR FRONT LEG
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_1 = 0
        Q2_2 = -pi/8
        ...
        Q4_2 = -pi/8
        Q4_3 = 5*pi/8
    elif(f_sq == 2): #Lift leg 2 turn leg 3
        Q3_1 = 0.785
        Q1_1 = 0
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        ...
        Q4_2 = -pi/8
        Q4_3 = 5*pi/8
    elif(f_sq == 3):#Lift leg 4 turn leg 2
        Q2_1 = pi/8  #SMALL ANGLE FOR FRONT LEG
        Q1_1 = 0
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_2 = -pi/8
