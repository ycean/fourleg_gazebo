...
def FS_define_B0(Pcomx,Pcomy,Pcomz,Orient,fs,loop = None):

    roll,pitch,yaw = Orient

    f_sq = fs % 4
    #Walking Sequence : 3 - 1 - 4 - 2
    if (f_sq == 0): #Lift leg 3 turn leg 2
        if (loop == 0): #Initial step
            ...
            Q4_2 = -pi/8
            Q4_3 = 5*pi/8
    elif(f_sq == 1): #Lift leg 1 turn leg 3
        Q1_1 = 0
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_1 = 0
        ...
        Q4_2 = -pi/8
        Q4_3 = 5*pi/8
    elif(f_sq == 2): #Lift leg 4 turn leg 1
        ...
        Q4_2 = -pi/8
        Q4_3 = 5*pi/8
    elif(f_sq == 3):#Lift leg 2 turn leg 4
        Q1_1 = 0
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_1 = 0
    ...
    if (f_sq == 0):#Lift leg 3 turn leg 2
        ...
        print("P4,P3,P2,P4")
        fs_X = [round(P4[0],4),round(P3[0],4),round(P2[0],4),round(P4[0],4)]
        fs_Y = [round(P4[1],4),round(P3[1],4),round(P2[1],4),round(P4[1],4)]
    elif(f_sq == 2):#Lift leg 4 turn leg 1
        print("P3,P1,P2,P3")
        ...
        print("P3,P1,P4,P3")
        fs_X = [round(P3[0],4),round(P1[0],4),round(P4[0],4),round(P3[0],4)]
        fs_Y = [round(P3[1],4),round(P1[1],4),round(P4[1],4),round(P3[1],4)]
