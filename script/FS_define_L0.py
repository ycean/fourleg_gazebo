...
def FS_define_L0(Pcomx,Pcomy,Pcomz,Orient,fs,loop = None):

    roll,pitch,yaw = Orient

    f_sq = fs % 4
    #Walking Sequence : 4 - 2 - 1 - 3
    if (f_sq == 0): #Lift leg 4 turn leg 3
        if (loop == 0): #Initial step
            ...
            Q2_2 = -pi/8
            Q2_3 = 5*pi/8
            Q3_1 = -pi/4    # leg 3 turn in -ve
            Q3_2 = -pi/8
            Q3_3 = 5*pi/8
            Q4_1 = 0
            Q4_2 = -pi/8
            Q4_3 = 5*pi/8
    elif(f_sq == 1): #Lift leg 2 turn leg 4
        Q1_1 = 0
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_1 = 0
        ...
        Q3_2 = -pi/8
        Q3_3 = 5*pi/8
        Q4_1 = -pi/8    #SMALLER ANGLE FOR FRONT LEG    # leg 4 turn in -ve
        Q4_2 = -pi/8
        Q4_3 = 5*pi/8
    elif(f_sq == 2): #Lift leg 1 turn leg 2
        Q1_1 = 0
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_1 = pi/4     # leg 2 turn in +ve
        Q2_2 = -pi/8
        Q2_3 = 5*pi/8
        Q3_1 = 0
        Q3_2 = -pi/8
        ...
        Q4_2 = -pi/8
        Q4_3 = 5*pi/8
    elif(f_sq == 3):#Lift leg 3 turn leg 1
        Q1_1 = pi/8    #SMALLER ANGLE FOR FRONT LEG     # leg 1 turn in +ve
        Q1_2 = -pi/8
        Q1_3 = 5*pi/8
        Q2_1 = 0
        Q2_2 = -pi/8
    ...
    if (f_sq == 0):#Lift leg 4 turn leg 3
        print("P1,P3,P2,P1")
        fs_X = [round(P1[0],4),round(P3[0],4),round(P2[0],4),round(P1[0],4)]
        fs_Y = [round(P1[1],4),round(P3[1],4),round(P2[1],4),round(P1[1],4)]
    elif(f_sq == 1):#Lift leg 2 turn leg 4
        print("P4,P1,P3,P4")
        fs_X = [round(P4[0],4),round(P1[0],4),round(P3[0],4),round(P4[0],4)]
        fs_Y = [round(P4[1],4),round(P1[1],4),round(P3[1],4),round(P4[1],4)]
    elif(f_sq == 2):#Lift leg 1 turn leg 2
        print("P3,P2,P4,P3")
        fs_X = [round(P3[0],4),round(P2[0],4),round(P4[0],4),round(P3[0],4)]
        fs_Y = [round(P3[1],4),round(P2[1],4),round(P4[1],4),round(P3[1],4)]
    elif(f_sq == 3):#Lift leg 3 turn leg 1
        print("P4,P1,P2,P4")
        fs_X = [round(P4[0],4),round(P1[0],4),round(P2[0],4),round(P4[0],4)]
        fs_Y = [round(P4[1],4),round(P1[1],4),round(P2[1],4),round(P4[1],4)]
